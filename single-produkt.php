...
<div class="singleview_container">
			<div class="logo singleview">
                <a href="https://truttedyret.dk/kea/2_sem/bogino_eksamen/bogino_wp/" class="logo_desktop"><img src= "<?php echo get_stylesheet_directory_uri() ?>/assets/bogino_logo_v2.svg" alt=""></a>
                <a href="https://truttedyret.dk/kea/2_sem/bogino_eksamen/bogino_wp/" class="logo_mobile"><img src= "<?php echo get_stylesheet_directory_uri() ?>/assets/bogino_logo_mobile.svg" alt=""></a>
            </div>
		...
		<script>
			/** @format */
			const url = "https://truttedyret.dk/kea/2_sem/bogino_eksamen/bogino_wp/wp-json/wp/v2/produkt/" + <?php echo get_the_ID() ?>;
			const colourUrl = "https://truttedyret.dk/kea/2_sem/bogino_eksamen/bogino_wp/wp-json/wp/v2/produkt/" + <?php echo get_the_ID() ?>;
